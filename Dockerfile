FROM radixdev.azurecr.io/radix-magnus-miniapp-server:radix-cache-main AS cache_layer
RUN echo "from cache layer" > /tmp/msg
...
COPY . /app
COPY --from=cache_layer /tmp/msg /tmp/msg
